...
| Shirt detail         | `/shirts/[shirt]`                       | Presents an individual shirt with its rendered SVG, confirmed match record and venue/competition splits, notable matches and linked results. |
...
| Name the XI          | `/name-the-xi`                          | Runs a daily lineup quiz from a match with eleven recorded starters; saves progress locally and links to the match on completion.            |
...
- Logged-in supporters can keep multiple Fantasy XIs private, duplicate and
  edit them, and explicitly create or permanently revoke public share links.
- Removing a supporter profile deletes its passport and programme-collection
  records and saved Fantasy XIs from D1.
