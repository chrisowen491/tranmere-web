...
module.exports = function () {
  return {
    ...
    buildPageView: function (view, pageTpl, path, noindex) {
      view.url = path;
    ...
    findAllPlayers : async function() {
       var query = encodeURIComponent("{listTranmereWebPlayerTable(limit:300){items{name picLink}}}");
