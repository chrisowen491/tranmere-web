              ...
              <div className="row separated">
                ...
                <article className="col-md-8 content-body">
                  ...
                  {topScorers.map((player) => (
                    <div className="card stacked" style={{marginBottom:"50px"}} key={player.Season}>
                        <div className="card-body" style={{backgroundImage:`url(${player.bio?.picLink})`, backgroundPositionX: "right", backgroundSize:"contain", backgroundRepeat: "no-repeat"}}>
                            <div className="row gutter-2 align-items-center">
                                <div className="col">
                                    <a href={`/page/player/${player.Player}`} className="topic">
                                        <h3 className="card-title mb-1">{player.Season}</h3>
                                        <h3 className="card-title mb-1">{player.Player}</h3>
                                        <p className="card-text mb-2">{player.goals} goals</p>
                                    </a>
                                </div>
                            </div>
                        </div>
