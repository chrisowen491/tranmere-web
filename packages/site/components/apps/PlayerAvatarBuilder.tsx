...
export function PlayerAvatarBuilder() {
    ...
    const [img, setImg] = useState('1966/simple/ffd3b3/none/000000/fcb98b/LightGray/8e740c')
                            ...
                            <div className="widget">
                                <form action={onSubmit}>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <select className="form-control form-control-sm" id="kit" name="kit">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <select className="form-control form-control-sm" id="skinColour" name="skinColour">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <select className="form-control form-control-sm" id="neckColour" name="neckColour">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <select className="form-control form-control-sm" id="hair" name="hair">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <select className="form-control form-control-sm" id="colour" name="colour">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <select className="form-control form-control-sm" id="highlights" name="highlights">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <select className="form-control form-control-sm" id="feature" name="feature">
                                            <option>none</option>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <select className="form-control form-control-sm" id="background" name="background">
                                    ...
                                    <button type="submit" className="btn btn-sm btn-primary btn-rounded btn-player-builder">Search</button>
                                </form>
                            </div>
                        </aside>
                                    ...
                                    <div className="col-6">
                                        <div className="row gutter-2">
                                            <div className="col">
                                                ...
                                                <h4>Link: <a href={`${base}${img}`}>here</a></h4>
                                            </div>
                                        </div>
                                    </div>
