...
export function ChatBlock(props: { placeholder?: string }) {
  ...
  const butttonClass =
    "rounded-md bg-sky-500 dark:bg-sky-500 px-2 py-2 text-xs font-semibold text-white shadow-sm hover:bg-green-600 dark:hover:bg-sky-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 mb-4 mr-2";
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="w-full mx-auto px-4 pb-2 sm:px-6 sm:pb-32 sm:pt-16 lg:max-w-7xl lg:px-8">
        <div className="bg-white px-6 py-16 sm:py-16 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-8 text-pretty text-lg font-medium text-gray-500 sm:text-xl/8">
              Ask questions about players, opponents, matches, and more.
            </p>
            <button
              type="button"
              onClick={() => {
        ...
        <div
          className="overflow-auto relative bottom-16 max-h-128  scrollbar scrollbar-thumb-indigo-600 scrollbar-track-gray-200"
          ref={messagesContainerRef}
        >
          <div
            className={`flex flex-col items-center p-4 grow overflow-hidden`}
          >
